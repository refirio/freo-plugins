...
/* メイン処理 */
function freo_display_page_sibling()
{
	global $freo;
	...
	$freo->smarty->assign(array(
		...
		'plugin_page_sibling_associates' => $page_associates,
		'plugin_page_sibling_filters'    => $page_filters,
		'plugin_page_sibling_securities' => $page_securities,
		'plugin_page_sibling_tags'       => $page_tags,
		'plugin_page_sibling_files'      => $page_files,
		'plugin_page_sibling_thumbnails' => $page_thumbnails,
		'plugin_page_sibling_images'     => $page_images
	));
